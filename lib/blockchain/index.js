...
class Blockchain {
    constructor(dbName, proofSystem) {
    ...
    checkBlock(newBlock, previousBlock, referenceBlockchain = this.blocks) {
        ...
        this.proofSystem.assertBlock(this, newBlock);
        ...
        if (!isInputsAmountGreaterOrEqualThanOutputsAmount) {
            ...
            throw new BlockAssertionError(`Invalid block balance: inputs sum '${sumOfInputsAmount}', outputs sum '${sumOfOutputsAmount}'`, null, { sumOfInputsAmount, sumOfOutputsAmount });
        }
    ...
    checkTransaction(transaction, referenceBlockchain = this.blocks) {
        ...
        if (!isNotInBlockchain) {
            ...
            throw new TransactionAssertionError(`Transaction '${transaction.id}' is already in the blockchain`, null, transaction);
        }
        ...
        if (!isInputTransactionsUnspent) {
            ...
            throw new TransactionAssertionError(`Not all inputs are unspent for transaction '${transaction.id}'`, null, transaction.data.inputs);
        }
