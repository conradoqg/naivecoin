...
class ProofOfWork {
    ...
    static getDifficultyFromBlockchain(blockchain, index) {
        ...
        return Config.pow.getDifficulty(blockchain.blocks, index);
    }

    static buildProveData(blockchain, baseBlock) {
        return {
            baseBlock,
    ...
    static assertBlock(blockchain, block) {
