...
class Transaction {
    ...
    check() {
        ...
        if (!isEnoughFee) throw new TransactionAssertionError(`Not enough fee: expected '${FEE_PER_TRANSACTION}' got '${(sumOfInputsAmount - sumOfOutputsAmount)}'`, { sumOfInputsAmount, sumOfOutputsAmount, FEE_PER_TRANSACTION });
