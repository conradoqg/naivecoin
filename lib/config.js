...
module.exports = {
    ...
    genesisBlock: {
        index: 0,
        previousHash: '0',
        timestamp: 1611271997,
        nonce: 0,
        transactions: [
            {
                id: '000a4a0a4eaeab31a29ddc131fe280722f4f0c8801c5965f50b1ff21ef3d6403',
                hash: null,
                type: 'regular',
                data: {
                    inputs: [],
    ...
    pow: {
        getDifficulty: (blocks, index) => {
            ...
            // INFO: The difficulty is the formula that savulcoin choose to check the proof a work, this number is later converted to base 16 to represent the minimal initial hash expected value.
