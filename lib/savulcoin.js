...
module.exports = function savulcoin(host, port, peers, logLevel, name, proxyUrl, minerMode, rewardAddress) {
    ...
    minerMode = process.env.MINER_MODE || minerMode || false;
    ...
    let node = new Node(host, port, peers, blockchain, proxyUrl);
