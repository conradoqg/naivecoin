    ...
    constructor(port, node, blockchain, operator, miner) {
        ...
        app.post('/operator/wallets/:walletId/transactions', (req, res) => {
            ...
            try {
                ...
                else if (ex instanceof TransactionAssertionError) throw new HTTPError(400, 'Wasn\'t possible to create transaction', req.params, ex);
                else throw ex;
            }
        });
        ...
        app.post('/miner/mineInAnotherThread', (req, res, next) => {
            miner.mineInAnotherThread(req.body.rewardAddress)
                .then((newBlock) => {
