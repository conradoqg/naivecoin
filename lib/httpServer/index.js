        ...
        this.app.post('/miner/mine', (req, res, next) => {
            miner.mine(req.body.rewardAddress, req.body['feeAddress'] || req.body.rewardAddress, req.body.secretKey, req.body.publicKey)
                ...
                .catch((ex) => {
                    ...
                    else if (ex instanceof BlockAssertionError && ex.message.includes('Invalid proof-of-authority:')) next(new HTTPError(400, 'The secretKey and publicKey are not authorized to mine a block'), null, ex);
                    else next(ex);
                });
        });
