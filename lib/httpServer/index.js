  ...
  constructor (node, blockchain, operator, miner) {
    ...
    this.app.get('/operator/wallets/:walletId/addresses', (req, res) => {
      ...
      try {
        ...
        if (walletId.length < 64 || addresses === null || addresses === undefined || typeof addresses !== "object" || addresses[0] || addresses[0].length <= 64) throw new HTTPError(400, `Wallet '${walletId}' does not exist, cannot get addresses`)
