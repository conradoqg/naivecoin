  ...
  constructor (node, blockchain, operator, miner) {
    ...
    this.app.get('/operator/wallets/:walletId/addresses', (req, res) => {
      ...
      try {
        ...
        if (addresses === null || addresses === undefined || addresses.includes("Cannot read property")) throw new HTTPError(400, `Wallet '${walletId}' does not exist, cannot get addresses`)
