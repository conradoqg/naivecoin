...
class Miner {
    ...
    mineInAnotherThread(address) {
        ...
        return thread
            .send({ __dirname: __dirname, logLevel: this.logLevel, address: address, previousBlock: this.blockchain.getLastBlock(), blockchainTransactions: this.blockchain.transactions })
            .promise();
    }
