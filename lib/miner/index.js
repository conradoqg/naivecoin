...
class Miner {
    ...
    generateNextBlock(address, previousBlock) {
        ...
        // Confirm that the transaction ins't already in blockchain
        ...
        // TODO: Add fee transaction (1 satoshi per transaction), usually it is a fee over transaction size (not amount)
