...
class Miner {
    constructor(blockchain, logLevel, proofSystem, spawn = true) {
    ...
    mine(rewardAddress, feeAddress, secretKey, publicKey) {
        ...
        if (this.spawn) {
            ...
            return Promise.resolve(this.proofSystem.prove(this.proofSystem.buildProveData(this.blockchain, baseBlock, secretKey, publicKey)));
        }
    }
