...
class Miner {
    ...
    mine(address) {
        // TODO: The miner shouldn't add transactions that consumes the same output transaction and at least check if the output transaction is still valid and if the signature is good
