...
class Miner {
    ...
    mine(address) {
        let baseBlock = Miner.generateNextBlock(address, this.blockchain);
    ...
    static generateNextBlock(address, blockchain) {
        ...
        R.forEach((transaction) => {
            ...
            let transactionInputFoundAnywhere = R.map((input) => {
                ...
                // Find the candidate transaction in the selected transaction (avoiding double spending)
                ...
                // Find the candidate tranasction in the blockchain (avoiding mining invalid transactions)
        ...
        console.info(`Selected ${selectedTransactions.length} candidate transactions with ${rejectedTransactions} being ignored.`);
