...
class Operator {
    ...
    createTransaction(walletId, fromAddressId, toAddressId, amount, changeAddressId) {
        ...
        // TODO: This should validate the transaction for safety
        // TODO: The transaction build throws an assert exception, maybe it would be better to throw some known exception and to detail it to requester
